...
// Create the main viewer.
   ...
   gridClient.on('change', function () {
	console.log("change scale");
      viewer.scaleToDimensions(gridClient.currentGrid.width*0.19, gridClient.currentGrid.height*0.19);
      viewer.shift(gridClient.currentGrid.pose.position.x*(0.19),gridClient.currentGrid.pose.position.y*(0.19)); 


    document.getElementById("inline-range-scale").addEventListener('input', function () {
      scale = this.value * 0.01;
      console.log("new the scale is " + scale);
      console.log("x is " + gridClient.currentGrid.width);
      console.log("y is " + gridClient.currentGrid.height);
      
});
     //viewer.scaleToDimensions(gridClient.currentGrid.width ,gridClient.currentGrid.height);
     //viewer.shift(gridClient.currentGrid.pose.position.x*(0.5-scale),gridClient.currentGrid.pose.position.y*(0.5-scale)); 
    });
